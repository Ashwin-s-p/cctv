...
# Manually supplied metadata for each camera.
CAMERA_METADATA = {
    "CAM_01": {
        "timestamp": "2026-09-09T13:26:10Z",
        "latitude": 18.555137,
        "longitude": 73.961896
    },
    "CAM_02": {
        "timestamp": "2026-09-09T13:28:20Z",
        "latitude": 18.554309,
        "longitude": 73.960372
    }
}
...
def main():
    ...
    for item in all_camera_results:
        ...
        camera_metadata = CAMERA_METADATA.get(
            item["camera_id"]
        )
        ...
        events.append(
            {
                ...
                "timestamp":
                    camera_metadata["timestamp"],

                "latitude":
                    camera_metadata["latitude"],

                "longitude":
                    camera_metadata["longitude"],
